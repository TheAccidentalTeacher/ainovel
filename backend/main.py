...
def create_application() -> FastAPI:
    ...
    # Register API routes
    from api import health, projects, genres, outlines, story_bible, chapters, summaries, bulk_generation, export, premise_builder, chat, contexts, health_check, agents
    ...
    app.include_router(agents.router, tags=["agents"])  # 🤖 Multi-Agent System
